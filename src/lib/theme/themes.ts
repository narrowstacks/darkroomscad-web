...
export const THEMES: Record<ThemeName, ThemeTokens> = {
  dark: {
    vars: {
      "--bg": "#09090b", "--bg-rgb": "9,9,11", "--surface": "#121214", "--surface-muted": "#1c1c1f",
      ...
      "--on-primary": "#08120b", "--primary-rgb": "110,243,164",
  ...
  light: {
    vars: {
      "--bg": "#ffffff", "--bg-rgb": "255,255,255", "--surface": "#f8f9fa", "--surface-muted": "#f1f3f4",
      ...
      "--on-primary": "#ffffff", "--primary-rgb": "45,122,74",
  ...
  darkroom: {
    vars: {
      "--bg": "#000000", "--bg-rgb": "0,0,0", "--surface": "#0a0000", "--surface-muted": "#140000",
      ...
      "--on-primary": "#000000", "--primary-rgb": "255,42,42",
